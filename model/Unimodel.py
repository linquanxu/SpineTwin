...
class Unified_Model(nn.Module):
    def __init__(self, now_3D_input_size, in_chans=1,in_chans_2d=3, patch_size=16, num_classes=2, pre_trained=False, pre_trained_weight=None,
        now_2D_input_size=None,patch_size_2d=16,mode='joint'):
        ...
        # Initialize Embedding layer globally so it's available for any mode
        # self.video_embed = VideoBaseEmbedding(input_size_3D=now_3D_input_size, input_size_2D=now_2D_input_size)
